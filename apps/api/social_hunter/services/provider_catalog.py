...
def _default_secure_reference(credential_ref: str) -> str:
    explicit = {
        "BRAVE_SEARCH_API_KEY_REF": "BRAVE_SEARCH_API_KEY_",
        "GITHUB_TOKEN_REF": "SECURE_REF_GITHUB_TOKEN",
        "HIBP_API_KEY_REF": "SECURE_REF_HIBP_API_KEY",
        "IPINFO_TOKEN_REF": "SECURE_REF_IPINFO_TOKEN",
        "HUNTER_API_KEY_REF": "SECURE_REF_HUNTER_API_KEY",
        "PEOPLE_DATA_LABS_API_KEY_REF": "SECURE_REF_PEOPLE_DATA_LABS_API_KEY",
        "TWILIO_ACCOUNT_SID_REF": "SECURE_REF_TWILIO_ACCOUNT_SID",
        "TWILIO_AUTH_TOKEN_REF": "SECURE_REF_TWILIO_AUTH_TOKEN",
        "REDDIT_CLIENT_ID_REF": "SECURE_REF_REDDIT_CLIENT_ID",
        "REDDIT_CLIENT_SECRET_REF": "SECURE_REF_REDDIT_CLIENT_SECRET",
        "X_BEARER_TOKEN_REF": "SECURE_REF_X_BEARER_TOKEN",
        "SERPAPI_API_KEY_REF": "SECURE_REF_SERPAPI_API_KEY",
        "BING_SEARCH_API_KEY_REF": "SECURE_REF_BING_SEARCH_API_KEY",
        "TAVILY_API_KEY_REF": "SECURE_REF_TAVILY_API_KEY",
        "EXA_API_KEY_REF": "SECURE_REF_EXA_API_KEY",
        "GOOGLE_PLACES_API_KEY_REF": "SECURE_REF_GOOGLE_PLACES_API_KEY",
        "YELP_API_KEY_REF": "SECURE_REF_YELP_API_KEY",
        "SECURITYTRAILS_API_KEY_REF": "SECURE_REF_SECURITYTRAILS_API_KEY",
        "BUILTWITH_API_KEY_REF": "SECURE_REF_BUILTWITH_API_KEY",
        "WAPPALYZER_API_KEY_REF": "SECURE_REF_WAPPALYZER_API_KEY",
        "DNSDB_API_KEY_REF": "SECURE_REF_DNSDB_API_KEY",
        "FULLCONTACT_API_KEY_REF": "SECURE_REF_FULLCONTACT_API_KEY",
        "EXTERNAL_ENGINE_API_KEY_REF": "SECURE_REF_EXTERNAL_ENGINE_API_KEY",
    }
    return explicit.get(credential_ref, f"SECURE_REF_{credential_ref.removesuffix('_REF')}")
        ...
        for credential_ref in provider.credential_refs:
            refs.append(
                ApiKeyReference(
                    ...
                    connector_function=provider.connector_function,
                    vault_reference=_default_secure_reference(credential_ref),
...
def default_proxy_route_rules() -> list[ProxyRouteRule]:
    return [
        ...
        ProxyRouteRule(
            ...
            note="Use official profile APIs directly by default; credentials use secure references.",
        ),
    ]
